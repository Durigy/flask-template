...
# this can be used for generating ids of string lenght 20 
# or the default in modules if fine for small projects
def generate_id(query_table):
    id = ''
...
# returns turn is no an id is found in the database
